...
function ru_nbsp_typograf(string $text, bool $useHtmlNbsp = true): string
{
    ...
    $search = [
        ...
        // 2A) Короткие союзы/предлоги — строчные, внутри текста (с пробелами по краям)
        ' а ',
        ' и ',
        ' но ',
        ' или ',
        ...
        // 2B) Те же предлоги/союзы в начале предложения — заглавные, БЕЗ пробела слева
        'А ',
        'И ',
        'Но ',
        'Или ',
    ...
    $replace = [
        ...
        // 2A) Строчные предлоги/союзы внутри текста: пробел слева, NBSP справа
        ' а'   . $nbsp,
        ' и'   . $nbsp,
        ' но'  . $nbsp,
        ' или' . $nbsp,
        ...
        // 2B) Заглавные в начале предложения: NBSP сразу после слова, без пробела слева
        'А'   . $nbsp,
        'И'   . $nbsp,
        'Но'  . $nbsp,
        'Или' . $nbsp,
