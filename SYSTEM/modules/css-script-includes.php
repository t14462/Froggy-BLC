...
if($checkpermission) {
    ...
    $errmsg .= "<aside class='big infobox'><strong>
    <u>Никому</u> не сообщайте свой <em>секретный CSRF-токен!</em><br />
    <u>Не публикуйте адрес страницы</u>, находясь в <em>Админ-панели!</em><br />
